...
$AMANDA_DEBUG_DAYS = "4";
$ASSERTIONS = "1";
$BSDTAR = "/local/amanda_test/tmp/sysroots/x86_64-linux/usr/bin/bsdtar";
$BSDTCP_SECURITY = "yes";
$BSDUDP_SECURITY = "no";
$BSD_SECURITY = "no";
$CC = "i686-poky-linux-gcc  -m32 -march=core2 -mtune=core2 -msse3 -mfpmath=sse --sysroot=/local/amanda_test/tmp/sysroots/genericx86";
$CHECK_USERID = "1";
...
$MT = "/bin/mt";
$MTX = "mtx";
$MOUNT = "/local/amanda_test/tmp/sysroots/x86_64-linux/bin/mount";
$UMOUNT = "/local/amanda_test/tmp/sysroots/x86_64-linux/bin/umount";
$LPR = "/usr/bin/lpr";
$LPRFLAG = "-P";
$PS = "/bin/ps";
