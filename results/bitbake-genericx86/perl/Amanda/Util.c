...
#define SWIGTYPE_p_crc_t swig_types[2]
#define SWIGTYPE_p_double swig_types[3]
#define SWIGTYPE_p_file_lock swig_types[4]
#define SWIGTYPE_p_float swig_types[5]
#define SWIGTYPE_p_fs_usage swig_types[6]
#define SWIGTYPE_p_in_port_t swig_types[7]
...
XS(_wrap_crc32_finish) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj((uint32_t *)memcpy((uint32_t *)malloc(sizeof(uint32_t)),&result,sizeof(uint32_t)), SWIGTYPE_p_uint32_t, SWIG_POINTER_OWN | 0); argvi++ ;
...
XS(SWIG_init) {
  ...
  /*@SWIG:/local/amanda_test/tmp/sysroots/x86_64-linux/usr/bin/../share/swig/3.0.8/perl5/perltypemaps.swg,65,%set_constant@*/ do {
